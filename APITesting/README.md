...
## Deskripsi
Folder ini berisi dokumentasi dan hasil pengujian API yang dilakukan menggunakan Postman. Pengujian ini dilakukan sebagai latihan sekaligus portofolio dalam mempelajari API Testing pada REST API JSONPlaceholder.
...
- Melakukan positive dan negative testing
...
- JSONPlaceholder - REST API publik (jsonplaceholder.typicode.com) yang digunakan sebagai target pengujian

## HTTP Method yang Diuji
| Method | Deskripsi |
|--------|-----------|
| GET    | Mengambil data (list users, albums, detail post, dll) |
...
Lihat Dokumentasi Postman: https://documenter.getpostman.com/view/37115477/2sBY4WoGRE
